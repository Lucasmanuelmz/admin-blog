...
describe("Testado o aside do dashboard", () => {
  ...
  it("Deve retornar os links dentro de navegacao", () => {
    ...
    expect(
      screen.getByRole("link", { name: "Criar novo post" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: "Editar o post" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: "Categorias" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: "Criar nova categoria" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: "Editar categoria" }),
    ).toBeInTheDocument();
    expect(screen.getByRole("link", { name: "Autores" })).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: "Adicionar autor" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: "Editar autor" }),
    ).toBeInTheDocument();
    expect(screen.getByRole("link", { name: "Usuarios" })).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: "Editar usuario" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: "Adicionar usuario" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: "Administradores" }),
    ).toBeInTheDocument();
